...
- Api baseline (publication pending): sections/trace 4,5,6,9
- Architecture baseline (publication pending): sections/trace 7,8; BRD-A-04
...
Wave: 4
Domain: contracts
Blocked by: V1-001 (number pending), V1-002 (number pending)
Blocks: V1-004 (number pending), V1-027 (number pending), V1-040 (number pending), V1-045 (number pending), V1-050 (number pending)

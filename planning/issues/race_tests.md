...
- Architecture baseline (publication pending): sections/trace 7; NFR-02,NFR-03
...
Wave: 14
Domain: qa
Blocked by: V1-054 (number pending), V1-064 (number pending), V1-063 (number pending), V1-062 (number pending)

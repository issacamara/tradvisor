...
- Api baseline (publication pending): sections/trace 4,7
- Architecture baseline (publication pending): sections/trace 8; NFR-06,NFR-07
...
Wave: 12
Domain: backend
Blocked by: V1-041 (number pending), V1-047 (number pending), V1-045 (number pending), V1-049 (number pending), V1-076 (number pending)
Blocks: V1-054 (number pending)
